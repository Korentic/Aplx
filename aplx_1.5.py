...
def print_aplx_red_interface():
    ...
    print(banner)
    print(theme_text(" [Aplx V1.5 is active - running locally - No Internet Required]"))
    ...
    print(theme_text(" [Welcome to the version of aplx, V1.5]"))
    ...
    print(f"{RED}/theme            {DIM}Change banner color or gradient [NEW]{RESET}")
    print(f"{DIM}-------------------------------------------------------------{RESET}\n")
